...
// Designer-internal color editor. It is not a public CUI/XAML control.
...
public:
	void ShowAt(Window* form, int x, int y, D2D1_COLOR_F initialColor);
...
private:
	...
	bool _hoverOk = false;
	cui::core::Size _preferredSize{ 420.0f, 380.0f };
