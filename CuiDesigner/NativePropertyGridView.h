...
#include "../CUI/include/ObservableCollection.h"

// Designer-internal row editor. This is not a public CUI/XAML control type.
...
public:
	...
	using ItemCollection = OwnedObservableCollection<PropertyGridItem, PropertyGridView>;
...
private:
	...
	void BackspaceEdit();
	void DeleteEdit();
	void MoveEditCaret(int delta, bool extendSelection);
