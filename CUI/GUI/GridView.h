...
public:
	...
	D2D1_COLOR_F GridLineColor = D2D1_COLOR_F{ 0.72f, 0.75f, 0.82f, 0.55f };
	D2D1_COLOR_F AccentColor = D2D1_COLOR_F{ 0.3882f, 0.4000f, 0.9451f, 1.0f };
	float CellCornerRadius = 6.0f;
	float CellHorizontalPadding = 8.0f;
	float CellVerticalPadding = 3.0f;
	...
	D2D1_COLOR_F EditSelectedBackColor = { 0.3882f, 0.4000f, 0.9451f, 0.30f };
