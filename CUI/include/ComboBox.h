...
private:
	...
	D2D1_COLOR_F _accentColor = { 0.3882f, 0.4000f, 0.9451f, 1.0f };
	D2D1_COLOR_F _headerHoverBackColor = { 0.3882f, 0.4000f, 0.9451f, 0.06f };
	D2D1_COLOR_F _dropBackColor = { 1.0f, 1.0f, 1.0f, 0.98f };
	D2D1_COLOR_F _dropBorderColor = { 0.74f, 0.77f, 0.84f, 0.95f };
	D2D1_COLOR_F _selectedItemBackColor = { 0.3882f, 0.4000f, 0.9451f, 0.14f };
	D2D1_COLOR_F _underMouseBackColor = { 0.3882f, 0.4000f, 0.9451f, 0.09f };
	D2D1_COLOR_F _selectedItemForeColor = Colors::Black;
	D2D1_COLOR_F _underMouseForeColor = Colors::Black;
	D2D1_COLOR_F _scrollBackColor = Colors::LightGray;
	D2D1_COLOR_F _scrollForeColor = Colors::DimGrey;
	D2D1_COLOR_F _buttonBackColor = Colors::SkyBlue;
