...
private:
	...
	D2D1_COLOR_F _trackBackColor = D2D1_COLOR_F{ 0.65f, 0.65f, 0.65f, 0.60f };
	D2D1_COLOR_F _trackForeColor = D2D1_COLOR_F{ 0.20f, 0.55f, 0.95f, 0.85f };
	D2D1_COLOR_F _trackHoverColor = D2D1_COLOR_F{ 0.20f, 0.55f, 0.95f, 0.12f };
	D2D1_COLOR_F _trackBorderColor = D2D1_COLOR_F{ 1.0f, 1.0f, 1.0f, 0.12f };
	D2D1_COLOR_F _thumbColor = D2D1_COLOR_F{ 1.0f, 1.0f, 1.0f, 0.95f };
	D2D1_COLOR_F _thumbHoverColor = D2D1_COLOR_F{ 1.0f, 1.0f, 1.0f, 1.0f };
	D2D1_COLOR_F _thumbBorderColor = D2D1_COLOR_F{ 0.10f, 0.10f, 0.10f, 0.35f };
	D2D1_COLOR_F _thumbShadowColor = D2D1_COLOR_F{ 0.0f, 0.0f, 0.0f, 0.22f };
